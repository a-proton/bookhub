...
// Icons
import { User, Edit, Mail, Phone, BookOpen, Globe, Loader2, BookMarked, ShieldCheck, RefreshCw } from "lucide-react"

const Profile = () => {
  const { currentUser, userPreferences, updateUserProfile, fetchUserData, API_URL } = useAuth()
  ...
  useEffect(() => {
    ...
    console.groupEnd()
  }, [currentUser, userPreferences, dataLoading])
  ...
  // Fetch user data and preferences when component mounts or when user changes
  // Memoize the loadUserData function to prevent it from changing on every render
  const loadUserData = useCallback(async () => {
    if (dataFetched) return // Skip if data has already been fetched
  ...
  }, [fetchUserData, currentUser, toast, dataFetched])
  ...
  useEffect(() => {
    ...
    if (currentUser || userPreferences) {
      ...
      setFormData({
        ...
        preferredLanguages: ensureArray(userPreferences?.preferredLanguages || currentUser?.preferredLanguages),
        favoriteGenres: ensureArray(userPreferences?.favoriteGenres || currentUser?.favoriteGenres),
      })
    }
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/auth/update-profile`, {
        ...
        body: JSON.stringify({
          ...
          preferredLanguages: Array.isArray(formData.preferredLanguages) ? formData.preferredLanguages : [],
          favoriteGenres: Array.isArray(formData.favoriteGenres) ? formData.favoriteGenres : []
        })
      });
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: "Your profile information has been updated successfully. Book recommendations will be refreshed on your next visit to the home page."
        });
        setIsEditing(false);
        // Refresh user data
        fetchUserData();
    ...
    return (
      <div className="container mx-auto p-4 mt-8">
        <div className="flex justify-center items-center h-64 flex-col">
          ...
          {/* Add this button to your profile UI when there's an error */}
          <Button onClick={retryFetchUserData} variant="outline" className="mt-4">
      ...
      <div className="bg-gradient-to-r from-purple-700 to-purple-900 text-white p-8 rounded-t-lg shadow-lg">
        <div className="flex flex-col md:flex-row items-center gap-6">
          <Avatar className="h-24 w-24 border-4 border-white shadow-xl">
            <AvatarFallback className="bg-white text-purple-700 text-3xl">{userInitial}</AvatarFallback>
          </Avatar>
          ...
          <Button variant="secondary" size="sm" className="md:ml-auto" onClick={() => setIsEditing(true)}>
      ...
      >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="font-medium">{currentUser?.email || "Not provided"}</div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="font-medium">{userPreferences?.age || currentUser?.age || "Not provided"}</div>
                </div>

                <div className="space-y-2">
                  <Label className="text-sm text-gray-500">Gender</Label>
                  <div className="font-medium capitalize">
                    {userPreferences?.gender || currentUser?.gender || "Not provided"}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="font-medium">
                    {userPreferences?.location || currentUser?.location || "Not provided"}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {Array.isArray(userPreferences?.preferredLanguages) &&
                    ...
                    ) : Array.isArray(currentUser?.preferredLanguages) && currentUser.preferredLanguages.length > 0 ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {Array.isArray(userPreferences?.favoriteGenres) && userPreferences.favoriteGenres.length > 0 ? (
                    ...
                    ) : Array.isArray(currentUser?.favoriteGenres) && currentUser.favoriteGenres.length > 0 ? (
        ...
        <TabsContent value="membership" className="p-6">
          <div className="text-center p-8">
            ...
            <p className="text-gray-500 mb-6">You don't have an active membership.</p>
            <Button onClick={() => navigate("/membership")}>View Membership Plans</Button>
          </div>
        </TabsContent>
      </Tabs>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  value={Array.isArray(formData.preferredLanguages) ? formData.preferredLanguages.join(", ") : ""}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  id="favoriteGenres"
                  name="favoriteGenres"
                  value={Array.isArray(formData.favoriteGenres) ? formData.favoriteGenres.join(", ") : ""}
                  onChange={handleArrayChange}
      ...
      {process.env.NODE_ENV !== "production" && (
        <div className="fixed bottom-4 right-4 z-50">
          <Button
            ...
            onClick={() => {
              console.log("Current API URL:", API_URL || "Not available")
